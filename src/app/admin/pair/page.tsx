...
const MISSING_STEP: Record<string, number> = {
  ...
  // A shop/install photo with a fix fills an empty pin (admin photo route;
  // a partner's EXIF shop photo sets it outright), so re-shooting in step 6
  // is the fix. A legacy row can also be pinned from Admin → Stores → Edit →
  // Map pin.
