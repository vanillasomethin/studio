...
export default function OfflinePage() {
  return (
    <div style={{ minHeight: '100svh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', textAlign: 'center', fontFamily: 'var(--font-manrope), system-ui, sans-serif' }}>
      ...
      <button
        id="offline-retry"
        type="button"
        style={{ padding: '12px 28px', borderRadius: 999, border: 'none', background: '#0a0a0a', color: '#fff', fontFamily: 'var(--font-manrope), sans-serif', fontWeight: 600, fontSize: 14, cursor: 'pointer' }}
      >
        Try again
      </button>
