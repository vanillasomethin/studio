...
export default function AliveBeforeAfter() {
  ...
  return (
    <div style={{ maxWidth: '100%' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12, fontFamily: 'var(--font-sans), sans-serif', fontSize: 10, letterSpacing: '0.22em', textTransform: 'uppercase', opacity: 0.35 }}>
        <span>Without</span>
      ...
      <p style={{ marginTop: 12, textAlign: 'center', fontFamily: 'var(--font-sans), sans-serif', fontSize: 10, letterSpacing: '0.28em', textTransform: 'uppercase', opacity: 0.28 }}>
        Drag to compare
      </p>
    </div>
  );
