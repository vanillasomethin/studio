...
- Company name shown to brands is **VS Collective LLP** everywhere (Razorpay checkout displays "ALIVE") — don't reintroduce "Alive Media" / "Alive Advertising Solutions". EXCEPTION (Deepak, 2026-09-08): the campaign ToS header (`BRAND_AGREEMENT_TITLE`) and both acceptance checkbox sentences deliberately say **"Alive Advertising"** — #218 "fixed" them to VS Collective LLP and was reverted the same day at his request; don't fix them again (the party clause and Digital Acceptance blocks still name VS Collective LLP, which is what makes the header branding acceptable).
