...
NVIDIA_API_KEY                  # build.nvidia.com key — preferred provider for AI product/flyer images (falls back to Gemini)
NVIDIA_IMAGE_MODEL              # NVIDIA image model path (default black-forest-labs/flux.1-schnell)
NVIDIA_IMAGE_STEPS             # diffusion steps (default 4)
