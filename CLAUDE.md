...
- Entity display is split (Deepak's call, 2026-09-08): marketing/product footers credit **ALIVE Advertising Pvt. Ltd.** (homepage, /deals, /dashboard, /brand-onboarding, /store, /store-dashboard — don't "fix" them to VS Collective); legal surfaces use the registered entity **VS Collective LLP** (/terms, /privacy, agreements, the campaign ToS title; Razorpay checkout displays "ALIVE"). Don't reintroduce "Alive Media" / "Alive Advertising Solutions"
