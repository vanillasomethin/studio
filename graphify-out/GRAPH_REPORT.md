...
1. `cn()` - 48 edges
2. `apiFetch()` - 27 edges
3. `ALIVE Advertising Platform — CLAUDE.md` - 18 edges
4. `compilerOptions` - 16 edges
5. `Logo()` - 14 edges
6. `publicUrl()` - 14 edges
7. `recordError()` - 14 edges
8. `hashStack()` - 13 edges
9. `Button` - 11 edges
10. `Card` - 11 edges
...
Cohesion: 0.06
Nodes (30): metadata, EluIdentify(), Providers(), BeforeInstallPromptEvent, PwaInstallBanner(), PwaRegister(), ErrorState(), iconBg() (+22 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (36): BLANK, CsvRow, Product, ProductsTab(), Action, ActionType, actionTypes, addToRemoveQueue() (+28 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (32): respond(), RespondInput, buildLearningArtifact(), emitLearningArtifact(), JsonLike, LearningArtifact, LearningArtifactInput, LearningOutcome (+24 more)
...
Cohesion: 0.05
Nodes (24): Campaign, CampaignsPanel(), ContentTab, fadeIn, Flyer, fmt(), LayoutsTab, MonitoringTab (+16 more)
...
Cohesion: 0.12
Nodes (11): MANGALURU, Props, STATUS_COLOR, FleetMap, View, fmtHours(), ReportsTab(), Device (+3 more)
...
Cohesion: 0.15
Nodes (13): slides, Carousel, CarouselApi, CarouselContent, CarouselContext, CarouselContextProps, CarouselItem, CarouselNext (+5 more)
...
Cohesion: 0.14
Nodes (9): BLANK_FORM, INTERVAL_MARKS, nowLocal(), RECURRENCE_LABELS, SchedulesTab(), TARGET_MODES, TargetMode, TimingMode (+1 more)
...
Cohesion: 0.16
Nodes (8): MONO, Props, statusColor(), SyncStatus(), Options, relativeTime(), SaveStatus, useAutoSave()

### Community 35 - "Community 35"
Cohesion: 0.14
Nodes (11): BLANK_FORM, FormState, POSITION_META, TARGET_MODES, TargetMode, TYPE_META, DeviceGroup, Overlay (+3 more)

### Community 36 - "Community 36"
Cohesion: 0.21
Nodes (9): ContactFormProps, DialogContent, DialogDescription, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle, Input (+1 more)
...
Cohesion: 0.24
Nodes (8): dayOfWeekIndex(), DAYS, getWeekStart(), HOURS, PALETTE, Props, ScheduleCalendar(), Schedule
...
Cohesion: 0.29
Nodes (7): AliveBeforeAfter, CITIES, HERO_STATES, HeroState, Home(), mediaUrl(), StoreLocationsMap
...
Cohesion: 0.40
Nodes (4): fmtMonth(), StorePayment, StorePaymentsTab(), StoreSummary
...
Cohesion: 0.40
Nodes (3): discount(), Offer, ProductCard()
